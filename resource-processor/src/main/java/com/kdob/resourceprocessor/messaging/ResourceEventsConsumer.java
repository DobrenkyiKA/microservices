...
public class ResourceEventsConsumer {
    ...
    private final ProcessingCompletionPublisher processingCompletionPublisher;
    ...
    public void onResourceCreated(final String resourceIdPayload) {
        ...
        processingCompletionPublisher.publishProcessingCompleted(resourceId);
        log.info("Processing completed for resourceId=[{}]", resourceId);
    }
